    ...
    <div className="max-w-6xl mx-auto px-4 space-y-16">
      <header className="space-y-6">
        ...
        <p className="text-slate-600 dark:text-slate-300 max-w-4xl leading-relaxed">
          ...
          networks, trusted retail partners, and service centers that reinforce
          reliability and brand loyalty. Our mission is to connect communities
          with innovative technology while fostering sustainable economic
          growth.
        </p>
      </header>
      ...
      <section className="grid md:grid-cols-2 gap-10 items-start">
        <div className="space-y-4">
          ...
          <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
            Dedicated after-sales care through hotline, authorized centers, and
            digital channels ensures satisfaction and retention. Feedback loops
            drive iterative improvements in service quality and product
            relevance.
          </p>
        </div>
