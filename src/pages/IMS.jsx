        ...
        <div className="max-w-5xl mx-auto space-y-12">
          ...
          <Section title="Core Pillars">
            <ul className="grid sm:grid-cols-2 gap-3 text-sm">
              <li>
                <strong>Quality Management:</strong> Monitoring & optimization
                of processes to reduce defects and boost satisfaction.
              </li>
              <li>
          ...
          <Section title="Vision & Training">
            ...
            <p className="text-slate-700 dark:text-slate-300">
              <strong>Training & Awareness:</strong> Ongoing programs ensure
              every employee understands and applies IMS principles.
            </p>
          </Section>
